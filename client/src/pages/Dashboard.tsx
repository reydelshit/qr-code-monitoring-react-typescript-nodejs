...
const chartData = [
  { month: 'January', desktop: 186, mobile: 80, color: '#0D7C66' },
  { month: 'February', desktop: 305, mobile: 200, color: '#821131' },
  { month: 'March', desktop: 237, mobile: 120, color: '#2563eb' },
  { month: 'April', desktop: 73, mobile: 190, color: '#7c3aed' },
  { month: 'May', desktop: 209, mobile: 130, color: '#db2777' },
  { month: 'June', desktop: 214, mobile: 140, color: '#ea580c' },
  { month: 'July', desktop: 189, mobile: 100, color: '#65a30d' },
  { month: 'August', desktop: 239, mobile: 120, color: '#0891b2' },
  { month: 'September', desktop: 349, mobile: 200, color: '#4f46e5' },
  { month: 'October', desktop: 278, mobile: 190, color: '#b91c1c' },
  { month: 'November', desktop: 298, mobile: 210, color: '#854d0e' },
  { month: 'December', desktop: 259, mobile: 220, color: '#115e59' },
];
